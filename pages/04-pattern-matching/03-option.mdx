...
1. Napisz metodę `maybe_icecream`, która zwróci ile porcji lodów zostało w lodowce (w zależności od pory roku). Napraw również test `raw_value`, aby poprawnie sprawdzał ilość porcji.
    ```rust
