...
Ilustracja koncepcji posiadania zostanie przedstawiona na typie tekstowym (`String`), który przechowywany jest na stercie.
...
W Rust każda wartość ma jednego właściciela (ang. *owner*), który określa jej czas życia (ang. *lifetime*). Gdy właściciel jest zwalniany (ang. *dropped*), zwalniana jest równie wartość będąca jego własnością. 
