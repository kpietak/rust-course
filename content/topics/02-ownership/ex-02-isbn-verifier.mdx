...
Format ISBN-10 to 9 cyfr (od 0 do 9) plus jeden znak kontrolny (cyfra lub znak X). W przypadku, gdy znakiem kontrolnym jest X, reprezentuje on wartość „10”. Numery ISBN-9 mogą być przekazywane z myślnikami lub bez nich, a ich poprawność można sprawdzić za pomocą następującego wzoru:
